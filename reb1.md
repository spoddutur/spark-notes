...
1. **Demo: Discuss common mistake and a spark-native solution without broadcasting**
2. **What did we achieve by this spark-native solution**
3. **FAQ**
4. **Key TakeOuts of this approach**
